...
const CadastroUpdate = (props) => {
    const navigation = useNavigation();
    const navigateToLista = () => navigation.navigate('Lista');
    const handleNavigation = () => navigateToLista();
    ...
    return (
        <View style={styles.container}>
            <View style={styles.areaHeader}>
                <TouchableOpacity style={styles.botaoVoltar} onPress={handleNavigation}>
...
export default withFormik({
    ...
    handleSubmit: (values) => {
        ...
        //             [values.nome, values.quantidade, id]
        //         );
        //     }
        // );
    },
